...
# Grit 600 is intentionally excluded at the request of the experiment author.
    ...
    for grit in GRITS:
        ...
        runs.append(
            SandpaperRun(
                grit=grit,
                run_dir=run_dir,
                mean_roughness=float(metadata["roughness"]["mean"]),
...
def _make_grit_plot(runs: list[SandpaperRun]) -> None:
    ...
    ax.set_title("Marigold appearance roughness across sandpaper grits")
    ...
    ax.text(
        0.01,
        0.02,
        "Grit 600 omitted from this figure.",
